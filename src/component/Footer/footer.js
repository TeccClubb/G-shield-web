...
export default function Footer() {
  ...
  <div className="grid grid-cols-2 md:grid-cols-5 gap-35 ml-[40px] mx-auto text-sm ">
    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6  flex justify-between items-center self-stretch   text-gray-500 text-sm font-medium  leading-normal ">
        <p>© 2025 GShieldVPN. All rights reserved.</p>
        <p>Powered by <span className="font-semibold text-gray-900">Tecclub</span></p>
      </div>
      </div>
